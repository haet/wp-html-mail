...
?>
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td class="header-image" align="<?php echo $options['headerimg_align']; ?>" style="text-align: <?php echo $options['headerimg_align']; ?>;">
							<?php echo $headerimg; ?>
						</td>
					</tr>
				</table>
			...
			?>
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td class="header-image" align="<?php echo $options['headerimg_align']; ?>" style="
					...
					<tr>
						<td class="header-text" align="<?php echo $options['headeralign']; ?>" style="text-align: <?php echo $options['headeralign']; ?>">
							<?php echo $headertext; ?>
						</td>
					</tr>
				</table>
