...
haet_mailbuilder.close_wysiwyg_sidebar = function ($settings, $sidebar, $textarea, apply_changes) {
    var $ = jQuery;
...
jQuery(document).ready(function ($) {
    ...
    $('#mailbuilder-content').on('click', '.mb-contentelement-content', function (e) {
        ...
        $element_content.find('.mb-edit-wysiwyg').each(function () {
            ...
            if ($settings.hasClass('active')) {
                var $previous_textarea = $('#mailbuilder-content .mb-contentelement-content.editing .mb-edit-wysiwyg textarea');
                mb_text.apply_content($previous_textarea, tinymce.editors['mb_wysiwyg_editor'].getContent());
                haet_mailbuilder.serialize_content();
                $settings.find('.mb-apply,.mb-cancel').off('click');
                $('#mailbuilder-content .mb-contentelement-content.editing').removeClass('editing');
            }
            ...
            $settings.find('.mb-apply').on('click', function () {
                haet_mailbuilder.close_wysiwyg_sidebar($settings, $sidebar, $textarea, true);
                $element_content.removeClass('editing');
            });

            $settings.find('.mb-cancel').on('click', function () {
                haet_mailbuilder.close_wysiwyg_sidebar($settings, $sidebar, $textarea, false);
                $element_content.removeClass('editing');
            });
    ...
    $('#mailbuilder-header  .mailbuilder-hide-button,#mailbuilder-footer .mailbuilder-hide-button').click(function (e) {
        e.preventDefault();
        var $button = $(this);
        var $element = $button.parent();
        $('#' + $button.data('status-field')).val(($element.hasClass('mailbuilder-hidden') ? 0 : 1));
