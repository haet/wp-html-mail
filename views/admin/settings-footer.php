...
?>
<div class="postbox">
	<h3 class="hndle"><span><?php esc_html_e( 'Footer', 'wp-html-mail' ); ?></span></h3>
	<div style="" class="inside">
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row"><label for="haet_mailfooterbackground"><?php esc_html_e( 'Background color', 'wp-html-mail' ); ?></label></th>
					<td>
						<input type="text" class="color" id="haet_mailfooterbackground" name="haet_mail_theme[footerbackground]" value="<?php echo esc_attr( $theme_options['footerbackground'] ); ?>">
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><label for="haet_mailfooter"><?php esc_html_e( 'Footer', 'wp-html-mail' ); ?> <?php $this->multilanguage->maybe_print_language_label( $theme_options, 'footer' ); ?></label></th>
					<td>
						<?php
							...
							wp_editor(
								stripslashes( str_replace( '\\&quot;', '', $footer ) ),
								'haet_mailfooter',
								array(
									'textarea_name' => 'haet_mail_theme[' . $footer_field_key . ']',
									'wpautop'       => false,
									'textarea_rows' => 6,
								)
							);
