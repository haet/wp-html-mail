        ...
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" class="regular-text" id="haet_mailfromname" name="haet_mail[fromname]" value="<?php echo sanitize_text_field( stripslashes( $options['fromname'] ) ); ?>" required>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="haet_mailfromaddress"><?php _e('Email sender address','wp-html-mail'); ?></label></th>
                    <td>
                        <input type="text" class="regular-text" id="haet_mailfromaddress" name="haet_mail[fromaddress]" value="<?php echo sanitize_text_field( $options['fromaddress'] ); ?>" required>
                    </td>
                </tr>
                <tr valign="top">
