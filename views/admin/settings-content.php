...
?>
<div class="postbox">
	<h3 class="hndle"><span><?php esc_html_e( 'Content', 'wp-html-mail' ); ?></span></h3>
	<div style="" class="inside">
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row"><label for="haet_mailcontentbackground"><?php esc_html_e( 'Background color', 'wp-html-mail' ); ?></label></th>
					<td>
						<input type="text" class="color" id="haet_mailcontentbackground" name="haet_mail_theme[contentbackground]" value="<?php echo esc_attr( $theme_options['contentbackground'] ); ?>">
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="haet_mailheadlinefont"><?php esc_html_e( 'Headline Font', 'wp-html-mail' ); ?></label>
					</th>
					<td>
						<?php
				...
				<tr>
					<th scope="row">
						<label for="haet_mailsubheadlinefont"><?php esc_html_e( 'Subsubheadline Font', 'wp-html-mail' ); ?></label>
					</th>
					<td>
						<?php
							Haet_Mail()->font_toolbar(
				...
				<tr>
					<th scope="row">
						<label for="haet_mailtextfont"><?php esc_html_e( 'Content Font', 'wp-html-mail' ); ?></label>
					</th>
					<td>
						<?php
							Haet_Mail()->font_toolbar(
				...
				<tr>
					<th scope="row">
						<label for="haet_mailtextfont"><?php esc_html_e( 'Link styling', 'wp-html-mail' ); ?></label>
					</th>
					<td>
						<?php
							Haet_Mail()->font_toolbar(
