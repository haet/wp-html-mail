<div class="postbox">
	<h3 class="hndle"><span><?php esc_html_e( 'Use template for mails sent by your installed plugins', 'wp-html-mail' ); ?></span></h3>
	<ul style="" class="inside haet-mail-plugins clearfix">
		<?php
		foreach ( $active_plugins as $plugin_name => $plugin_data ) :
			include HAET_MAIL_PATH . 'views/admin/single-plugin.php';
		endforeach;

		foreach ( $available_plugins as $plugin_name => $plugin_data ) :
		...
		foreach ( $buyable_plugins as $plugin_name => $plugin_data ) :
